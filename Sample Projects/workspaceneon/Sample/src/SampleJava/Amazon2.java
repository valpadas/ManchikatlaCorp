...
public class Amazon2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if (text.contains(expected)) {
			...
			System.out.println("Get text of error message : "+text2);
			String expected1 = "We're sorry. We weren't able to identify you given the information provided.";

			if (text2.equalsIgnoreCase(expected1)) {
